...
const getWeatherByGeoLocation = async (location) => {
    const hourly = `&hourly=temperature_2m,relativehumidity_2m,apparent_temperature,weathercode,surface_pressure,windspeed_10m,winddirection_10m,precipitation,direct_radiation`;
